...
// Estilos de Navbar
const StyledColHV = styled(Col)`
  display: flex;
  align-items: center;
  justify-content: flex-end;
  padding: 0px;
`
const StyledButtonHv = styled(Button)`
  width: 100%;
  padding: 12px 24px; 
  border: none; 
  /* border-radius: 20px; */
...
const StyledPaddingResponsive = styled(AppBar)`
      ...
      >
        <Container fluid >
          <Row>
            ...
            <StyledColHV xs={6}>
              <StyledButtonHv colorScheme="blue" style={{ width: '200%', background: '#00b4d8', color: '#ffffff' }}>Curriculum</StyledButtonHv>
            </StyledColHV>
          </Row>
        </Container>
      </StyledPaddingResponsive>
